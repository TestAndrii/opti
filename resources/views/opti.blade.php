...
<head>
    ...
    <title>{{ env('APP_NAME', 'Laravel_opti') }}</title>
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-8xl mx-auto sm:px-8 lg:px-8">
        ...
        <a href="/">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-8 text-gray-200">
        ...
        <div class="mt-10 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                ...
                <form method="POST">
                    ...
                    <div class="form-group row">
                        <label for="review" class="col-sm-2 col-form-label">Отзыв</label>
                        <div class="col-sm-10">
                            <input type="text" name="review" id="review"
                                   class="form-control"
                                   required maxlength="255"
                                   placeholder="Отзыв" value="{{ old('review') }}">
                        </div>
                    </div>
